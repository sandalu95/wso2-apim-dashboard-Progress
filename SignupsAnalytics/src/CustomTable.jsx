        ...
        >
            <div className={classes.title}>
                <Typography variant='h6' id='tableTitle'>
                    <FormattedMessage id='table.heading' defaultMessage='SIGNEDUP TIMES' />
                </Typography>
            </div>
...
/**
 * Create React Component for Signedup Times Table
 */
class CustomTable extends React.Component {
    ...
    render() {
        ...
        tableData.forEach((dataUnit) => {
            counter += 1;
            dataNew.push({ id: counter, developer: dataUnit[0], signeduptime: dataUnit[1] });
        });
