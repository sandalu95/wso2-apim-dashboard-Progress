...
/**
 * Create React Component for Top API Creators
 * @class TopAPICreators1
 * @extends {Widget}
 */
class TopAPICreators1 extends Widget {
    /**
     * Creates an instance of TopAPICreators1.
    ...
    /**
     * Return the content of TopAPICreators1 widget
     * @returns {ReactElement} Render the content of Top API Creators widget
     * @memberof TopAPICreators1
     * */
    getApiCreators() {
        return (
    ...
    /**
     * @inheritDoc
     * @returns {ReactElement} Render the Top API Creators widget
     * @memberof TopAPICreators1
     */
    render() {
                        ...
                        >
                            ...
                            <Typography component='p'>
                                <FormattedMessage
                                    ...
                                    defaultMessage='Cannot fetch provider configuration for TOP API CREATORS widget'
                                />
                            </Typography>
                        </Paper>
                    </div>
