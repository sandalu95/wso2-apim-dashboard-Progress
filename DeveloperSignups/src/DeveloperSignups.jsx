...
/**
 * Create React Component for Developer Signups Count
 * @class DeveloperSignups
 * @extends {Widget}
 */
class DeveloperSignups extends Widget {
    /**
     * Creates an instance of DeveloperSignups.
     * @param {any} props @inheritDoc
     * @memberof DeveloperSignups
     */
    constructor(props) {
        super(props);
    ...
    /**
     * @inheritDoc
     * @returns {ReactElement} Render the Developer Signups Count widget
     * @memberof DeveloperSignups
     */
    render() {
